...
пилот не начался, живых гостей нет, окно деплоя стоит ноль. После первого отеля
та же правка стоила бы окна с гостями (spec 0035 §11). Соседняя 0024 выбрала
обратное и по другой причине: у `is_urgent` умолчание `false` — честный ответ
для любой вставки, у `origin` честного умолчания не существует.
"""
