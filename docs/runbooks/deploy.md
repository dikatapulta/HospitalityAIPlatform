...
команду контейнера. Проверка провалилась — контейнер выходит с кодом 1 и одной
строкой ошибки в логах; деплой краснеет сразу, а не ждёт healthcheck до таймаута.
