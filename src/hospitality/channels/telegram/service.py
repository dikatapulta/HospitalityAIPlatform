...
Развилка «кто персонал» — единственное место в системе, где это решается: чат
обязан входить в МНОЖЕСТВО staff-чатов тенанта (дефолтный
`TELEGRAM_STAFF_CHAT_ID` + чаты служб и чат утренней сводки из конфига тенанта;
состав множества и почему он такой — spec 0026 §4). Множество строк со
...
async def _staff_chat_ids() -> frozenset[str]:
    """Чаты персонала тенанта: дефолтный из окружения, чаты служб, чат сводки.

    Состав множества и почему чат утренней сводки в нём — spec 0026 §4.
