...
no-store, запрет фреймов, `Referrer-Policy: strict-origin` — наружу уходит
источник без пути, а `no-referrer` обнулял бы `Origin` у форм и ронял вход,
#164) — страницы живут на личных телефонах за
